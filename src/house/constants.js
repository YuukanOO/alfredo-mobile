...
export const DEVICE_SCENE_KEY = `${NAME}/DEVICE_SCENE_KEY`;
export const ADAPTERS_SCENE_KEY = `${NAME}/ADAPTERS_SCENE_KEY`;
...
export const DEVICE_FORM_NAME = `${NAME}/DEVICE_FORM_NAME`;
